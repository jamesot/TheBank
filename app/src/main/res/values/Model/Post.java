...
import com.rosenta.standard.Interface.VolleyCallback;
import com.rosenta.standard.utils.Utils;
...
//            }
            ...
            protected Response<String> parseNetworkResponse(NetworkResponse response) {
                ...
                com.rosenta.standard.Model.AppController.get().checkSessionCookie(response.headers);

                return super.parseNetworkResponse(response);
            }
        };
        // Adding request to request queue
        com.rosenta.standard.Model.AppController.getInstance().addToRequestQueue(req);
    ...
    public static void getData(String url, Response.Listener<String> response) {
        ...
        // Adding request to request queue
        com.rosenta.standard.Model.AppController.getInstance().addToRequestQueue(stringRequest);
