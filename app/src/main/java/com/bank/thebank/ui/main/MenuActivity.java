package com.bank.thebank.ui.main;
...
//                Toast.makeText(MenuActivity.this, receivedString, Toast.LENGTH_LONG).show();
        ...
        TextView title = findViewById(R.id.menu_TV);
//        if (Utils.checkDefaults("ui_user_name",this))
//            title.setText(Utils.getDefaults("ui_user_name", this));
