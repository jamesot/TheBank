package com.bank.thebank.utils;
...
public class Utils {
    ...
    //    Setting up base URL for the bank API
    public static String baseURL(Context context) {
        return "https://" + Utils.getDefaults("company", context) + "41.89.64.3/api/";
    }
    ...
    public static HashMap<String, String> AunthenticationHeaders(Context context) {
        ...
        headers.put("Content-Type", "application/json; charset=utf-8");
        String creds = String.format("%s:%s", "123123", "9999");
...
//                        dialog.cancel();
    ...
    public static void showDialogMore(String msg, final Context ctx, String positive, String negative, final Intent intent, final Intent intent2) {
//        AlertDialog.Builder builder1 = new AlertDialog.Builder(ctx);
        AlertDialog.Builder builder1 = new AlertDialog.Builder(new ContextThemeWrapper(ctx, R.style.myDialog));
        builder1.setMessage(msg);
        builder1.setCancelable(true);
    ...
    public static void getToken(Context ctx, ServerCallback callback) {
        ...
        credentials.put("userid", "123123");
        credentials.put("password", "9999");
        PostData postData = new PostData(ctx);
        postData.post("login/mobile", credentials, null, null, callback);
